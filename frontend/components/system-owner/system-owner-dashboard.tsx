...
import { DashboardMetrics, SystemOwnerData } from "@/types/types";
import { getSystemOwnerDashboardData } from "@/actions/dashboard.action";
...
export function SystemOwnerDashboard() {
  ...
  const fetchDashboardData = async () => {
    ...
    // Fetch metrics data
    const data = await getSystemOwnerDashboardData({ params });
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-3xl font-bold">
                {metrics?.ticketStats.totalTickets || 0}
              </div>
              <p className="text-xs text-muted-foreground">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-3xl font-bold text-yellow-600">
                {metrics?.ticketStats.pendingTickets || 0}
              </div>
              <p className="text-xs text-muted-foreground">
                Awaiting resolution
              </p>
              {metrics?.ticketStats.totalTickets && (
                <div className="mt-2">
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div
                      ...
                      style={{
                        width: `${
                          (metrics.ticketStats.pendingTickets /
                            metrics.ticketStats.totalTickets) *
                          100
                        }%`,
                      }}
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-3xl font-bold text-green-600">
                {metrics?.ticketStats.solvedTickets || 0}
              </div>
              <p className="text-xs text-muted-foreground">
                ...
                <div className="mt-2">
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div
                      ...
                      style={{
                        width: `${
                          (metrics.ticketStats.solvedTickets /
                            metrics.ticketStats.totalTickets) *
                          100
                        }%`,
                      }}
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <div className="text-2xl font-bold text-blue-600">
                  {metrics?.itPersonCount
                    ? Math.round(
                        (metrics.userCount || 0) / metrics.itPersonCount
                      )
                    : 0}
                  :1
                </div>
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <div className="text-2xl font-bold text-purple-600">
                  {metrics?.totalUsers
                    ? Math.round(
                        ((metrics.adminCount || 0) / metrics.totalUsers) * 100
                      )
                    : 0}
                  %
                </div>
